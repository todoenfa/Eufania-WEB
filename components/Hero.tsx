        ...
        <div className="md:w-1/2 relative w-full">
          <div className="aspect-video md:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl md:rotate-2 relative group bg-slate-200">
            ...
            <img 
              ...
              onError={(e) => {
                  // Fallback seguro a Unsplash si falta la imagen local
                  e.currentTarget.src = "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?q=80&w=2070&auto=format&fit=crop";
              }}
            />
